...
test('Gemini 3.8 Flash is the default and first API choice', () => {
...
test('model labels and effort work for API and Antigravity ids', () => {
  assert.equal(friendlyModelName('gemini-3.8-flash'), 'Gemini 3.8 Flash')
  assert.equal(friendlyModelName('gemini-3.8-flash-medium'), 'Gemini 3.8 Flash (Medium)')

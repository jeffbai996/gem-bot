 ...
 *
 * Ported verbatim from gpt-bot (2026-09-16) — gem-bot had no global ceiling at
 * all, so a burst across many channels could open unbounded concurrent Gemini
 * calls and spike host memory. Kept byte-identical to gpt-bot's copy so a fix
 * in either can be diffed straight across; the bots differ only in how they
 * construct it.
 *
